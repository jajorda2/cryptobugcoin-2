...
uint256 hashGenesisBlock("0x187a081491eedb503b84ebc0e744b4ea4d14d21d98f14f7e8817f15d6e892e19");
static CBigNum bnProofOfWorkLimit = CBigNum().SetCompact(504365644); // CryptoBugCoin: starting difficulty is 1 / 2^12
...
{
    // CryptoBugCoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 840000); // CryptoBugCoin: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 302400; // CryptoBugCoin: 3.5 days
static const int64 nTargetSpacing = 150; // CryptoBugCoin: 2.5 minutes
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // CryptoBugCoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // CryptoBugCoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xb81b5d149dd65c1fb55d18b4a3c983123d3ce5ba320dbc3bcd06b2d8296a243b");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "Trump decries immigrants from shithole countries coming to US";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 5000000000;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("4bdc00b5409fdcd9d24d061879def6c0405a9c804f85082d1f949fffd00559939f94f67b6ef58514ad11f774c3679c7dbbdf7dea30931e2cf04589e4be25a4d9e8") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1515760563;
        block.nBits    = 504365644;
        block.nNonce   = 3872079216;

        if (fTestNet)
        {
            block.nTime    = 1515760563;
            block.nNonce   = 309789244;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0xb39d87aa5a0b78e4596c03d14a4455c919cfa83f4d68624713b96a5d9f4f36b6"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // CryptoBugCoin: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("CryptoBugCoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("CryptoBugCoinMiner : ProcessBlock, block not accepted");
    }
